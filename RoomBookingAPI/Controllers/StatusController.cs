...
namespace RoomBookingAPI.Controllers
{
    ...
    public class StatusController : ControllerBase
    {
        ...
        public StatusController(RoomBookingDBContext context)
        {
            _context = context;
        }
        ...
        public IActionResult GetStatus()
        {
            ...
            IEnumerable<Status> statusvalues = _context.Status.ToList();
            return Ok(statusvalues);
        }

        // GET: api/Status/5
        [HttpGet("{id}")]
        public  IActionResult GetStatus([FromRoute] int id)
        {
